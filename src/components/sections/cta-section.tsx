...
import { ArrowRight, Mail, Phone, Package } from "lucide-react"
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative min-h-screen flex items-center py-24 content-layer">
      <div className="max-w-7xl mx-auto px-6">
        <div ref={contentRef} className="relative max-w-5xl mx-auto p-8 md:p-12 lg:p-16 rounded-3xl bg-gradient-to-br from-card/80 via-card/50 to-primary/5 backdrop-blur-sm border border-border overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 text-pretty">{t("description")}</p>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-foreground">{t("email2")}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <Link href="/contact">
              <div className="p-6 md:p-8 rounded-2xl bg-background/50 backdrop-blur-sm border border-border hover:border-primary/50 transition-all duration-300 cursor-pointer">
                <h3 className="text-xl font-semibold text-foreground mb-6">{t("quoteTitle")}</h3>
                <p className="text-muted-foreground mb-6">{t("quoteDesc")}</p>
...
export function Footer() {
  ...
  return (
    <footer className="relative py-12 border-t border-border content-layer">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services" className="text-muted-foreground hover:text-foreground transition-colors">{t("services")}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/testimonials" className="text-muted-foreground hover:text-foreground transition-colors">{t("testimonials")}</Link></li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="w-8 h-8 rounded-lg bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors">
